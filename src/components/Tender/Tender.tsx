...
import { Search, MapPin, Eye, Clock4, Hourglass, MessageCircle, ChevronRight, SlidersHorizontal } from 'lucide-react' // Added SlidersHorizontal

// --- Type Definition for Tender ---
...
const mockTenders: TenderData[] = [
  ...
  },
  {
    ...
    title: "Market şəbəkəsi üçün vitrin soyuducuların təchizatı",
    description: `Bakı şəhərində yerləşən market şəbəkəsi üçün müxtəlif ölçülü vitrin soyuducuların alınması və quraşdırılması`,
    status: "Davam edir",
    location: "Bakı",
    postedAgo: "3 ay əvvəl",
    deadline: "24.01.24-dək",
              ...
              >
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <p className="text-sm text-zinc-600 mb-10 line-clamp-2">{tender.description}</p>
                     <a href={`/tender/${tender.id}`} className="text-sm hover:underline flex items-center gap-1 mb-4">
