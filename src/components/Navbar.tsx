...
export default function Navbar() {
  ...
  return (
    <header className="z-20 w-full py-6 px-4 bg-white border-b border-zinc-200 sticky top-0">
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="md_lg:hidden p-4 pt-2 bg-white border-t border-zinc-100">
